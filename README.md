...
A simple web interface is available for uploading PDF files and generating their hierarchical structures:

1. Set your Google API key: `$env:GOOGLE_API_KEY = "your_api_key"`
2. Run the web UI: `python web_ui.py`
3. Open http://127.0.0.1:5000 in your browser
4. Upload a PDF file and process it
5. View the JSON structure or download it

The web UI uses the same processing logic as the command-line tool but provides a user-friendly interface for file uploads.
